...
@section('styles')
    @vite(['resources/css/restrictions.css'])
@endsection
...
<div>
    ...
    <div class="container-fluid main_content p-3 m-3">
        <header class="d-flex justify-content-between align-items-center bg-light p-3 header_zones">
            <h2 class="h3 mb-3">Restrições</h2>
            <button type="button" class="btn btn-primary light" data-bs-toggle="modal" data-bs-target="#restrictionAddModal" id="btnAddrestriction">Nova Restrição</button>
        </header>
        <div class="row">
            <hr>
                    ...
                    <thead>
                        <tr class="table-primary">
                            ...
                            <th class="taCentro" onclick="ordernaTAB(1)"> 
                                Observações <i style="padding-left: 5px;" class="fa fa-sort"></i>
                            </th>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header pb-0">
                    <h3 id="restrictionAddModalTitle" class="modal-title">Adicionar Nova Restrição</h3>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-lg">
                                <label for="restrictionAddNome" class="form-label">Nome do Terreno</label>
                                <input type="text" class="form-control addNome" id="restrictionAddNome" placeholder="Insira o Nome" name="AddNome">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control addObs" id="restrictionAddObs" placeholder="Observações/detalhes do terreno" rows="5" name="addObs"></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="table-responsive" id="gradeTable">
                            <table id="tab" class="table table-striped table-hover" style="font-size: 12px">
                                <thead>
                                    <tr class="table-primary">
                                        <th class="taCentro"> 
                                            Idade <i style="padding-left: 5px;" class="fa fa-sort"></i>
                                        </th>
                                        <th class="taCentro"> 
                                            Área <i style="padding-left: 5px;" class="fa fa-sort"></i>
                                        </th>           
                                        <th class="taCentro"> 
                                            Ações<i style="padding-left: 5px;" ></i>
                                        </th>
                                ...
                                <tbody> 
                                    <tr>
                                        ...
                                        <td><input class="form-control" type="email" name="area[]" required></td>
                                        <td><button class="form-control" type="button" onclick="removerLinha(this)">Remover</button></td>
                                    </tr>   
                        ...
                        <br>
                        <button type="button" onclick="adicionarLinha()">Adicionar Coordenadas</button>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="restrictionDeleteModal">Apagar Restrição</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
<script>
    function adicionarLinha() {
        const tabela = document.getElementById('gradeTable').getElementsByTagName('tbody')[0];
        ...
        celulaNome.innerHTML = '<input class="form-control" type="text" name="age[]" required>';
        celulaEmail.innerHTML = '<input class="form-control" type="email" name="area[]" required>';
        celulaTelefone.innerHTML = '<input class="form-control" type="text" name="coords[]" required>';
        celulaAcoes.innerHTML = '<button class="form-control" type="button" onclick="removerLinha(this)">Remover</button>';
    }
    ...
    document.getElementById('formGrade').onsubmit = function(event) {
